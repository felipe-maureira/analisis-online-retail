...
├── analisis_online_retail.ipynb                    # Notebook Jupyter con visualizaciones
└── README.md
```
...
```bash
git clone https://github.com/felipemaureira62-blip/analisis-online-retail.git
```
2. Instalar dependencias
```bash
pip install pandas matplotlib seaborn openpyxl
```
3. Colocar el archivo `online_retail.xlsx` en la misma carpeta
4. Abrir y ejecutar el notebook
```bash
jupyter notebook analisis_online_retail.ipynb
```

## Autor
**Felipe Maureira** — Estudiante de Ingeniería en Ciencia de Datos  
