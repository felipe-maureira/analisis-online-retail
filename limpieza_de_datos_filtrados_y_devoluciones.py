...
# ================================================
#   ANALISIS EXPLORATORIO - FILTRADO Y DEVOLUCIONES
#   Dataset: online_retail.xlsx (2009-2011)
#   Autor: Felipe
#   Enfoque: Datos filtrados (sin outliers) y devoluciones
# ================================================
...
# SEGMENTACION: solo filtrado y devoluciones
df_filtrado = df[(df["Quantity"] > 0) & (df["Quantity"] < 1000)]
devoluciones = df[df["Quantity"] < 0]

datasets = [("FILTRADO", df_filtrado), ("DEVOLUCIONES", devoluciones)]
